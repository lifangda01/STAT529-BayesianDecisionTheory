...
def main():
	...
	find_bayes_credible_region_std_beta(1.2, 1.5, 0.95) # Bayes credible region is (0.202, 0.717)
	find_bayes_credible_region_jeffery(0.95) # Bayes credible region is (0.165, 0.776)
	find_bayes_credible_region_hist(hist_int, 0.95) # Bayes credible region is (0.200000, 0.700000)
